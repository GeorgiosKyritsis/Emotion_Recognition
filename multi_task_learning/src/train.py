...
## Read Emotion data
X_train_emotion = '../data/Emotion/FER2013Train/final_data_aug.npy'
X_train_emotion = np.load(X_train_emotion)
X_valid_emotion = '../data/Emotion/FER2013Valid/final_data.npy'
X_valid_emotion = np.load(X_valid_emotion)

Y_train_emotion = '../data/Emotion/FER2013Train/final_labels_data_aug.npy'
Y_train_emotion = np.load(Y_train_emotion)
Y_valid_emotion = '../data/Emotion/FER2013Valid/final_labels_data.npy'
Y_valid_emotion = np.load(Y_valid_emotion)

## Read Gender data
X_train_gender = '../data/Gender/Train/final_data.npy'
X_train_gender = np.load(X_train_gender)
X_valid_gender = '../data/Gender/Valid/final_data.npy'
X_valid_gender = np.load(X_valid_gender)

Y_train_gender = '../data/Gender/Train/final_labels_data.npy'
Y_train_gender = np.load(Y_train_gender)
Y_valid_gender = '../data/Gender/Valid/final_labels_data.npy'
Y_valid_gender = np.load(Y_valid_gender)

## Read Age data
X_train_age = '../data/Age/Train/final_data.npy'
X_train_age = np.load(X_train_age)
X_valid_age = '../data/Age/Valid/final_data.npy'
X_valid_age = np.load(X_valid_age)

Y_train_age = '../data/Age/Train/final_labels_data.npy'
Y_train_age = np.load(Y_train_age)
