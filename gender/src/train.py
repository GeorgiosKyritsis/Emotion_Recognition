...
# read the datasets
X_train = np.load('../../data/Gender/Train/final_data.npy')
Y_train = np.load('../../data/Gender/Train/final_labels_data.npy')

X_valid = np.load('../../data/Gender/Valid/final_data.npy')
Y_valid = np.load('../../data/Gender/Valid/final_labels_data.npy')
