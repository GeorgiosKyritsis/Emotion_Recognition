...
# read the datasets
X_train = np.load('../../data/Emotion/Train/final_data_aug.npy')
Y_train = np.load('../../data/Emotion/Train/final_labels_data_aug.npy')

X_valid = np.load('../../data/Emotion/Valid/final_data.npy')
Y_valid = np.load('../../data/Emotion/Valid/final_labels_data.npy')
